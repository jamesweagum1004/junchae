...
export default function AnalyticsSettings() {
  ...
  const stats = activeMode === 'secure'
    ? [
        { label: '일일 활성 사용자', value: '18,742', change: '+24.3%', positive: true },
        { label: '브릿지 오버레이 클릭', value: '12,481', change: '+31.7%', positive: true },
        { label: '평균 우회 시간', value: '4.5s', change: '0%', positive: true },
      ]
    : [
        { label: '일일 활성 사용자', value: '12,480', change: '+8.3%', positive: true },
        { label: '페이지뷰 (오늘)', value: '89,231', change: '+14.1%', positive: true },
